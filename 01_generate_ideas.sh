...
echo "3. Trouve un produit pertinent et copie l'URL de la page sur la colonne 'amazon_product_url'"
echo "4. Copie son ASIN (ex: B0CXYZ1234) dans la colonne 'asin'"
echo "5. Fais ça pour toutes les nouvelles lignes que tu veux publier."

echo ""
read -p "⏳ Appuie sur [ENTRÉE] UNE FOIS QUE TU AS FINI DE REMPLIR LES ASIN ET URL ET SAUVEGARDÉ LE FICHIER CSV..."

echo "🚀 Poussée des modifications vers GitHub..."
git add data/pins_ideas_to_fill.csv
git commit -m "chore: Add new product ideas and ASINs"
git push
